...
class Sample_Scene_Enemy : public Scene
{
public:
		...
		void Load()
	{
		...
		/////////////////////////////////////////////////////////////////////////////
<<<<<<<< Updated upstream:HewGame/HewGame/Sample_Scene_Enemy.h
		// エネミーオブジェクト
		/////////////////////////////////////////////////////////////////////////////
		auto enemy = Instantiate("enemy", L"asset/pic/hartG.png");
		enemy->transform.position = { -250.0f,-200.0f };
		enemy->AddComponent<Renderer>();
		auto enemyChaser = enemy->AddComponent<EnemyChaser>();
		ObjectManager::Find("Player");

		float evec = player->transform.position.x - enemy->transform.position.x;
...
========
		...
		breakScaffold->transform.scale = { 35.9f,29.0f };	// x: 35.0f, y: 29.0f を超えると実行できない
...
>>>>>>>> Stashed changes:HewGame/HewGame/Scene_Gimmick.h
		/////////////////////////////////////////////////////////////////////////////
	}
